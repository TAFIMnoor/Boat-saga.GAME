...
using namespace std;
using namespace sf;
RenderWindow app(VideoMode(700, 700), "boat saga Game!");
...
int main()
{
    ...
    Texture t1,t2,t3,t4;
    t1.loadFromFile("folder/Riverr.png");
    t2.loadFromFile("folder/platform.png");
    t3.loadFromFile("folder/pirate_ship.png");
    t4.loadFromFile("folder/font.png");
    ...
    Font myfont;
    if (!myfont.loadFromFile("folder/myfont.ttf"));
        Text a7,b;
