...
int main()
{
    ...
    if (!myfont.loadFromFile("myfont.ttf"));
        Text a7,b,e5,raw;
                    a7.setString("Press Enter To Play!");
                      a7.setFont(myfont);
                      a7.setCharacterSize(40);
                      a7.setScale(1.f,1.f);
                      //gametxt.setFillColor(Color::Red);
                      a7.setPosition(170,200);
     ...
     raw.setString("Warning!  Avoid collision with the blocks\n  by moving Left or Right to survive.");
                      raw.setFont(myfont);
                      raw.setCharacterSize(30);
                      raw.setScale(1.f,1.f);
                      //gametxt.setFillColor(Color::Red);
                      raw.setPosition(80,270);
